...
namespace NoxusBoss.Content.Projectiles.Pets
{
    public class BabyNoxus : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D handTexture = ModContent.Request<Texture2D>("NoxusBoss/Content/Projectiles/Pets/BabyNoxusHand").Value;
        ...
        {
            Texture2D backTexture = ModContent.Request<Texture2D>("NoxusBoss/Content/Projectiles/Pets/BabyNoxusBack").Value;
