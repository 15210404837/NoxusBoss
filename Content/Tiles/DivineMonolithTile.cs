...
namespace NoxusBoss.Content.Tiles
{
    public class DivineMonolithTile : ModTile
    {
        ...
        public override void NearbyEffects(int i, int j, bool closer)
        {
            ...
            {
                XerocDimensionSkyGenerator.InProximityOfDivineMonolith = true;
                XerocDimensionSkyGenerator.TimeSinceCloseToDivineMonolith = 0;
                ...
                if (Main.rand.NextBool(14) && !Main.gamePaused && !nearestPlayer.WithinRange(startingPoint, 100f))
                {
                    ...
                    // Play a pulse sound.
                    SoundEngine.PlaySound(SoundID.DD2_WitherBeastAuraPulse with { MaxInstances = 50, Pitch = -0.4f, Volume = 0.7f });
                }
            }
        }
        ...
        public override bool PreDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            if (frameX == 36 && frameY == 0)
            {
                ...
                spriteBatch.Draw(backglow, glowDrawPosition, null, Color.Purple with { A = 0 } * 0.8f, 0f, backglow.Size() * 0.5f, 0.4f, 0, 0f);
            }
