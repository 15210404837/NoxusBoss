...
{
    public class XerocRelicTile : ModTile
    {
        ...
        public virtual string RelicTextureName => "NoxusBoss/Content/Tiles/XerocRelicTile";
        ...
        public override void KillMultiTile(int i, int j, int frameX, int frameY)
        {
            if (frameX == 0 && frameY == 0)
                Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 32, 32, ModContent.ItemType<XerocRelic>());
        }
