...
namespace NoxusBoss.Content.Particles
{
    public class FruitOfLifeParticle : Particle
    {
        ...
        public override void Update()
        {
            ...
            Opacity = GetLerpValue(Lifetime, Lifetime - 120f, Time, true);
            ...
            if (Main.LocalPlayer.Hitbox.Intersects(CenteredRectangle(Position, Vector2.One * Scale * 20f)) && Time < Lifetime && Abs(Velocity.Y) <= 0.0001f)
            {
                Time = Lifetime;
