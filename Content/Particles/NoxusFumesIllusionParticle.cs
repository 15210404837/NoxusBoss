...
namespace NoxusBoss.Content.Particles
{
    public class NoxusFumesIllusionParticle : Particle
    {
        ...
        public override string Texture => "NoxusBoss/Content/Particles/NoxusFumesYharimIllusion";
        ...
        public override void CustomDraw(SpriteBatch spriteBatch)
        {
            ...
            if (Variant == 1)
                texture = ModContent.Request<Texture2D>("NoxusBoss/Content/Particles/NoxusFumesCalamitasIllusion").Value;
            if (Variant == 2)
