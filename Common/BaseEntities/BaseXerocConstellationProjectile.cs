...
{
    public abstract class BaseXerocConstellationProjectile : ModProjectile
    {
        ...
        public float GetStarMovementInterpolant(int index)
        {
            ...
            return Pow(GetLerpValue(starPrepareStartTime, starPrepareStartTime + 56f, Time, true), 0.68f);
        }
        ...
        public Vector2 GetStarPosition(int index)
        {
            ...
            starPosition += Lerp(-TwoPi, TwoPi, RandomFloat(ref starSeed)).ToRotationVector2() * Lerp(1.5f, 5.3f, RandomFloat(ref starSeed)) * StarRandomOffsetFactor;
        ...
        public void DrawStar(Vector2 drawPosition, float colorVariantInterpolant, float scale, int index)
        {
            ...
            DrawBloomFlare(drawPosition, colorVariantInterpolant, scale * XerocBoss.Myself.scale, index);
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            {
                float colorVariantInterpolant = Sqrt(RandomFloat(ref starSeed));
                ...
                scale = Remap(StarScaleFactor * 0.75f, scale, StarScaleFactor, 1f, 2.5f);
