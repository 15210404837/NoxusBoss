...
// This is mechanically equivalent to the ExobladeSlashShader shader I wrote for Calamity a while back.
...
float4 PixelShaderFunction(VertexShaderOutput input) : COLOR0
{
    ...
    float2 noiseCoords = coords * float2(1.0 / noiseDetail.x, noiseDetail.y) - float2(globalTime * 0.45, 0);
    ...
    color = lerp(color, float4(primaryColor, 1), noise2);
