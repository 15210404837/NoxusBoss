...
namespace NoxusBoss.Core.Graphics.SpecificEffectManagers
{
    public class CattailAnimationSystem : ModSystem
    {
        ...
        private static void DrawAnimation()
        {
            ...
            float opacity = GetLerpValue(0f, 0.06f, animationCompletion, true) * GetLerpValue(1f, 0.94f, animationCompletion, true);
            ...
            Vector2 centerOfScreen = new Vector2(Main.screenWidth, Main.screenHeight) * 0.5f;
            Vector2 lineScale = new(Main.screenWidth / line.Width * 1.1f, 1.4f);
            Main.spriteBatch.Draw(line, centerOfScreen, null, Color.Black * opacity * 0.75f, 0f, line.Size() * 0.5f, lineScale, 0, 0f);
            ...
            ChatManager.DrawColorCodedStringWithShadow(Main.spriteBatch, font, text, textDrawPosition, TextColor * opacity, 0f, Vector2.Zero, new(scale), -1f, 2f);
        }
