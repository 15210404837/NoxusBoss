...
namespace NoxusBoss.Core.Graphics.SpecificEffectManagers
{
    public class DivineMonolithGalaxySystem : ModSystem
    {
        public class Galaxy
        {
            ...
            public float Scale => GetLerpValue(0f, 6f, Time, true) * Lerp(1f, 1.5f, LifetimeCompletion) * GeneralScale;

            public float Opacity => GetLerpValue(0f, 9f, Time, true) * GetLerpValue(1f, 0.4f, Pow(LifetimeCompletion, 0.6f), true);
            ...
            public void Update()
            {
                ...
                for (int i = 0; i < dustCount; i++)
                {
                    ...
                    Dust light = Dust.NewDustPerfect(Center + Main.rand.NextVector2Circular(27f, 27f) * offsetScale + Velocity, 267, Velocity.ClampMagnitude(0f, 2f) * -2.6f, 0, dustColor);
