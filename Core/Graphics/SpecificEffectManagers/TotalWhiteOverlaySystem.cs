...
namespace NoxusBoss.Core.Graphics.SpecificEffectManagers
{
    public class TotalWhiteOverlaySystem : ModSystem
    {
        ...
        private void DrawWhite(GameTime obj)
        {
            ...
            Main.spriteBatch.Draw(WhitePixel, new Vector2(Main.screenWidth, Main.screenHeight) * 0.5f, null, Color.White * WhiteInterpolant, 0f, WhitePixel.Size() * 0.5f, pixelScale, 0, 0f);
