...
namespace NoxusBoss.Core.Graphics.SpecificEffectManagers
{
    public class ScreenEffectSystem : ModSystem
    {
        ...
        {
            if (!CalamityConfig.Instance.Screenshake || NoxusBossConfig.Instance.VisualOverlayIntensity <= 0f)
                return;
        ...
        {
            if (!CalamityConfig.Instance.Screenshake || AberrationLifetimeRatio > 0f || NoxusBossConfig.Instance.VisualOverlayIntensity <= 0f)
                return;
