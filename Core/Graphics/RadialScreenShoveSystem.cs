...
namespace NoxusBoss.Core.Graphics
{
    ...
    {
        public override bool IsSceneEffectActive(Player player) => NoxusBossConfig.Instance.VisualOverlayIntensity >= 0.01f && CalamityConfig.Instance.Screenshake && RadialScreenShoveSystem.DistortionPower >= 0.01f;
